...
class AttitudeDisplayWidget(QLabel):
    ...
    def paintEvent(self, e):
        ...
        for i in range(min_pitch, max_pitch, spacing):
            ...
            painter.drawText(text_distance * 1.1, nearest_pitch_delta + int(font_size / 2), "{}".format(abs(i)))
            painter.drawText(-(text_distance * 1.1 + (font_size - 2) * 2), nearest_pitch_delta + int(font_size / 2), "{:2}".format(abs(i)))
