...
class GraphsTab(TabCommon):
    def __init__(self, tab_name, parent=None):
        ...
        layout.addWidget(self.addWidget(GraphWidget(title="Speeds", source_list=[Constants.vertical_speed_key, Constants.ground_speed_key])), 1, 2)
        layout.addWidget(self.addWidget(GraphWidget(title="XYZ Accelerations", source_list=[Constants.acceleration_x_key, Constants.acceleration_y_key, Constants.acceleration_z_key])), 1, 3)
        ...
        layout.addWidget(self.addWidget(GraphWidget(title="Magnetometer readings", source_list=[Constants.magnetometer_x_key, Constants.magnetometer_y_key, Constants.magnetometer_z_key])), 2, 3)
        layout.addWidget(self.addWidget(GraphWidget(title="Pressure, Pressure, & Pressure", source_list=[Constants.barometer_pressure_key, Constants.barometer_pressure_2_key, Constants.press_ref_key])), 3, 1)
