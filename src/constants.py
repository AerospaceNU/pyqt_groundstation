...
class Constants:
    ...
    payload_run_time_key = "payload_run_time"
    ...
    payload_acceleration_key = "payload_acceleration"
    ...
    payload_user_input_message_key = 'payload_input_message'
    payload_orientation_key = 'payload_orientation'
