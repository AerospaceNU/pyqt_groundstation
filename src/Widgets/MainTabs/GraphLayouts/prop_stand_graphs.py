...
class PropStandGraphs(GraphLayoutCommon):
    def __init__(self, parent=None):
        ...
        layout.addWidget(self.addWidget(GraphWidget(title="Manifold Thermocouples", source_list=["manifoldInletThermo", "manifoldOutletThermo"], start_min=-10, start_max=10)), 2, 2)
        layout.addWidget(self.addWidget(GraphWidget(title="Tank Thermocouples", source_list=["tank1Thermo", "tank2Thermo", "tank3Thermo"], start_min=-200, start_max=300)), 2, 3)
