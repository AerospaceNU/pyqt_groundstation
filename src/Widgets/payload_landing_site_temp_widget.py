import numpy as np
from PyQt5.QtChart import QBarSet, QChart, QChartView, QHorizontalBarSeries, QValueAxis
...
class LandingSiteTemperatureWidget(CustomQWidgetBase):
    def __init__(self, parent_widget: QWidget = None, source_list=None, default_temperature=0):
        ...
        self.chart.setTitle("Landing Site Temperature")
        ...
        self.resize(500, 275)  # Add extra height for the handle
